...
_upstream_pkgver=
pkgrel=1
pkgdesc='AI-first coding environment (nightly channel)'
arch=('x86_64')
url="https://www.cursor.com"
license=('LicenseRef-Cursor_EULA')
provides=('cursor')
conflicts=('cursor-bin' 'cursor-early-access-bin' 'cursor-nightly-bin')
_electron=
depends=(xdg-utils ripgrep $_electron nodejs
  'gcc-libs' 'hicolor-icon-theme' 'libxkbfile')
options=(!strip !debug) # Don't break ext of VSCode
_commit=
source=("https://downloads.cursor.com/production/${_commit}/linux/x64/deb/amd64/deb/cursor_${_upstream_pkgver}_amd64.deb"
...
sha512sums[0]=
noextract=(cursor_${_upstream_pkgver}_amd64.deb) # avoid double tarball
